...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference("Agenda.count") do
      post agendas_url, params: { agenda: { data_hora: @agenda.data_hora, id_cliente: @agenda.id_cliente, id_consultor: @agenda.id_consultor } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { data_hora: @agenda.data_hora, id_cliente: @agenda.id_cliente, id_consultor: @agenda.id_consultor } }
